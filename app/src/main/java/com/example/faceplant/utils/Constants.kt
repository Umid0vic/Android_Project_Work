...
object Constants {
    ...
    const val SEED_TYPE: String = "seedType"
    const val SEED_DATE: String = "dateOfPurchase"
    const val MORE_ABOUT_SEED: String = "moreAboutSeed"
    ...
    const val USER_PREFS: String = "userPreferences"
    const val USERNAME_PREF_KEY: String = "usernamePrefKey"
    const val EMAIL_PREF_KEY: String = "emailPrefKey"
